...
import static com.vinsonzhan.onekey.swipewithcallback.State.CLOSE;
...
public class EasySwipeMenuLayout extends ViewGroup {
    ...
    private SwipeStateChangeListener listener;

    public void setListener(SwipeStateChangeListener listener) {
...
//                }
    ...
    private void handlerSwipeMenu(State result) {
        if (listener != null)
            listener.onStateChange(result, getStateCache());
